...
import com.bernardo.dbi.client.renderer.provider.HairTextureProvider;
...
public class HairLayer extends RenderLayer<AbstractClientPlayer, PlayerModel<AbstractClientPlayer>> {
    ...
    public void render(
        ...
        ResourceLocation hair = HairTextureProvider.getHairTexture(player);

        VertexConsumer vertex = buffer.getBuffer(RenderType.entityCutoutNoCull(hair));
